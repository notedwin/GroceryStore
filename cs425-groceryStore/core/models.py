...
class Item(models.Model):
    ...
    discount_price = models.DecimalField(max_digits=4,decimal_places=2, blank=True, null=True)
    category = models.CharField(choices=CATEGORY_CHOICES,max_length=20)
    slug = models.SlugField()
    image = models.ImageField()
    alcohol_content = models.IntegerField(default=0, blank=True, null=True)
